...
from recipe_cost.cli import main
from recipe_cost.models import Note, ProjectState, Task
from recipe_cost.cli import demo_state
from recipe_cost.storage import load_state, save_state
from recipe_cost.models import generate_short_id
from recipe_cost.validation import normalize_tags, require_text, validate_task_status
from recipe_cost.services import (
    create_note,
    list_notes,
    get_note,
    update_note,
